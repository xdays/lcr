# -*- coding: utf-8 -*-
#
# Linux命令参考 documentation build configuration file, created by
...
latex_documents = [
  ('index', 'Linux.tex', u'Linux命令参考 Documentation',
   u'xdays', 'manual'),
]
...
man_pages = [
    ('index', 'linux', u'Linux命令参考 Documentation',
     [u'xdays'], 1)
]
...
texinfo_documents = [
  ('index', 'Linux', u'Linux命令参考 Documentation',
   u'xdays', 'Linux', 'One line description of project.',
   'Miscellaneous'),
]
